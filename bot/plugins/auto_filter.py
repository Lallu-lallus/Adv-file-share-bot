    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_message(
                ...
                text=f⚜️"Found page at @cmk_Links⚜️{(len_results)} ❣︎❣︎❣︎❣︎ 𝗡𝗜𝗡𝗚𝗔𝗟 𝗖𝗛𝗢𝗗𝗛𝗜𝗖𝗛𝗔 𝗠𝗢𝗩𝗜𝗘 𝗧𝗛𝗔𝗬𝗘 𝗞𝗔𝗔𝗡𝗨𝗡𝗡𝗔 𝗕𝗨𝗧𝗧𝗢𝗡 𝗖𝗟𝗜𝗖𝗞 𝗦𝗧𝗔𝗥𝗧 𝗔𝗗𝗜𝗞𝗞𝗨 𝗙𝗜𝗟𝗘 𝗟𝗔𝗕𝗛𝗜𝗞𝗞𝗨𝗠☟︎︎︎☟︎︎︎☟︎︎︎☟︎︎︎☟︎︎︎ : <code>{query}</code>",
